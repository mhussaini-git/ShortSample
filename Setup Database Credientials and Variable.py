#Setup Database Credientials and Variables
#Pulls from different databases to a datawarehouse

from variables import datawarehouse_name #Your Datawarehouse Name
